...
Public Class rptEnrollment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "stu_enroll.rptEnrollment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEnrollment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEnrollment = New rptEnrollment
        rpt.Site = Me.Site
        Return rpt
    End Function
